    ...
    <div id="container" class="container">
			...
			<form:form modelAttribute="pms" id="frm" name="frm" method="post">
				...
				<table class="table table-bordered">
					<tr>
						<th scope="row" width="30%">이름</th><td><input type="text" id="name" name="name" value="<c:out value='${result.name}'/>"/></td>
					</tr>
					<tr>
					...
					<tr>
						<th scope="row">SNS1</th><td><input type="text" id="sns1Addr" name="sns1Addr" value="<c:out value='${result.sns1Addr}'/>"/></td>
					</tr>
					<tr>
						<th scope="row">SNS2</th><td><input type="text" id="sns2Addr" name="sns2Addr" value="<c:out value='${result.sns2Addr}'/>"/></td>
					</tr>
					<tr>
						<th scope="row">SNS3</th><td><input type="text" id="sns3Addr" name="sns3Addr" value="<c:out value='${result.sns3Addr}'/>"/></td>
					</tr>
					<tr>
