...
-- 게시판템플릿
insert into LETTNTMPLATINFO(TMPLAT_ID,TMPLAT_NM,TMPLAT_COURS,USE_AT,TMPLAT_SE_CODE,FRST_REGISTER_ID,FRST_REGIST_PNTTM,LAST_UPDUSR_ID,LAST_UPDT_PNTTM) values ('TMPLAT_BOARD_DEFAULT','게시판 기본템플릿','/css/framework/cop/bbs/egovbbsTemplate.css','Y','TMPT01','USRCNFRM_00000000000',SYSDATETIME,'USRCNFRM_00000000000',SYSDATETIME);
